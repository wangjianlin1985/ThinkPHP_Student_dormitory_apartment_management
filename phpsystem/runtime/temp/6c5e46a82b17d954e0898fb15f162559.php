<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:88:"C:\xampp\htdocs\phpsystem\public/../application/back\view\classInfo\classInfo_query.html";i:1568719528;}*/ ?>
...
<div id="classInfo_manage_tool" style="padding:5px;">
	...
	<div style="padding:0 0 0 7px;color:#333;">
		<form id="classInfoQueryForm" method="post">
			...
			辅导员：<input type="text" class="textbox" id="fudaoyuan" name="fudaoyuan" style="width:110px" />
...
<div id="classInfoEditDiv">
	<form id="classInfoEditForm" enctype="multipart/form-data"  method="post">
		...
		<div>
			...
			<span class="inputControl">
				<input class="textbox" type="text" id="classInfo_fudaoyuan_edit" name="classInfo_fudaoyuan" style="width:200px" />
		...
		<div>
			...
			<span class="inputControl">
				<input class="textbox" type="text" id="classInfo_addTime_edit" name="classInfo_addTime" />
