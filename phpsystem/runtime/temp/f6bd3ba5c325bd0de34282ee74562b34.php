<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:84:"C:\xampp\htdocs\phpsystem\public/../application/back\view\login\password_modify.html";i:1538896143;}*/ ?>
<!DOCTYPE html>
<html>
...
<TABLE align="center"   cellSpacing=0 cellPadding=0 width="80%" border=0>
    ...
    <TR>
        <TD align="left" vAlign=top ><br>
            <form action="<?php echo url('login/changePassword'); ?>" method="post" name="form1" target="submitFrame">
